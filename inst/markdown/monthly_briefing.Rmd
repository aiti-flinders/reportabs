...
output: 
  pdf_document: 
    ...
    keep_tex: FALSE
fontsize: 10pt
geometry: margin = 1in, bottom = 1.75in
...
params:
  ...
  run: TRUE
  directory:
    value: "C:/Users/gamb0043/OneDrive - Flinders/Projects/R/Test Project/data"
  file:
    value: "old_abs.csv"
...
if (!is.null(params$directory)) {
  labour_force <- get(load(file.path(params$directory, params$file)))
...
abs_plot(labour_force, "Monthly hours worked in all jobs", params$state, params$years, series_type = params$series_type) +
  aes(linetype = state) +
  scale_linetype_manual(breaks = c(params$state, "Australia"), values = c(1,2))
```
