...
abs_plot(labour_force, "Employed full-time", params$state, params$years, series_types = params$series_type) +
  aes(linetype = state) +
  scale_linetype_manual(breaks = c(params$state, "Australia"), values = 1:2)

abs_plot(labour_force, "Employed part-time", params$state, params$years, series_types = params$series_type) +
  aes(linetype = state) +
  scale_linetype_manual(breaks = c(params$state, "Australia"), values = 1:2)
```
...
abs_plot(labour_force, "Unemployment rate", c(params$state, "Australia"), params$years, series_type = params$series_type, sex = c("Males", "Females"), facet = "gender") +
  aes(linetype = state) + 
  scale_linetype_manual(breaks = c(params$state, "Australia"), values = 1:2) 
```
