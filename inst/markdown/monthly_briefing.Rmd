...
`r {if(params$run) {hours_worked = read_absdata("hours_worked"); filter_list = list(state = params$state, series_type = params$series_type, indicator = "Monthly hours worked in all jobs")}}`
