...
if (params$palette == "legacy") Sys.setenv(R_REPORTABS_THEME = "legacy") 
...
abs_plot_line(labour_force, "Employed total", params$state, params$years, series_type = params$series_type) +
  aes(linetype = state) +
...
abs_plot_line(labour_force, "Employed full-time", params$state, params$years, series_type = params$series_type) +
  aes(linetype = state) +
  scale_linetype_manual(breaks = c(params$state, "Australia"), values = 1:2)

abs_plot_line(labour_force, "Employed part-time", params$state, params$years, series_type = params$series_type) +
  aes(linetype = state) +
  scale_linetype_manual(breaks = c(params$state, "Australia"), values = 1:2)
```
...
abs_plot_line(labour_force, "Unemployed total", params$state, params$years,  series_type = params$series_type) +
  aes(linetype = state) +
  scale_linetype_manual(breaks = c(params$state, "Australia"), values = c(1,2))
...
abs_plot_line(labour_force, "Unemployment rate", params$state, params$years, series_type = params$series_type) +
  aes(linetype = state) + 
  scale_linetype_manual(breaks = c(params$state, "Australia"), values = c(1,2))
```
...
abs_plot_line(labour_force, "Unemployment rate", c(params$state, "Australia"), params$years, series_type = params$series_type, sex = c("Males", "Females"), facet = "gender") +
  aes(linetype = state) + 
  scale_linetype_manual(breaks = c(params$state, "Australia"), values = 1:2) 
```
...
abs_plot_line(labour_force, "Participation rate", params$state, params$years, series_type = params$series_type) + 
  aes(linetype = state) + 
  scale_linetype_manual(breaks = c(params$state, "Australia"), values = c(1, 2))
```
...
abs_plot_line(labour_force, "Underemployment rate (proportion of labour force)", params$state, params$years, series_type = params$series_type) +
  aes(linetype = state) +
  scale_linetype_manual(breaks = c(params$state, "Australia"), values = c(1,2))
```

``` {r underemployment-number, echo = F,  fig.height = 4, fig.width = 8, units = 'cm'}
abs_plot_line(labour_force, "Underemployed total", params$state, params$years, series_type = params$series_type) +
  aes(linetype = state) +
  scale_linetype_manual(breaks = c(params$state, "Australia"), values = c(1,2))
```
...
abs_plot_line(labour_force, "Underutilisation rate", params$state, params$years, series_type = params$series_type) +
  aes(linetype = state) +
  scale_linetype_manual(breaks = c(params$state, "Australia"), values = c(1,2))
```

``` {r underutilisation-number, echo = F,  fig.height = 4, fig.width = 8, units = 'cm'}
abs_plot_line(labour_force, "Underutilised total", params$state, params$years, series_type = params$series_type) +
  aes(linetype = state) +
  scale_linetype_manual(breaks = c(params$state, "Australia"), values = c(1,2))
```
...
abs_plot_line(hours_worked, "Monthly hours worked in all jobs", params$state, params$years, series_type =  params$series_type) +
  aes(linetype = state) +
  scale_linetype_manual(breaks = c(params$state, "Australia"), values = c(1,2))
```
