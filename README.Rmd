...
typing `plot_` and pressing tab will show the included plots.  `abs_plot(labour_force, indicator = "Employed total", states = "Australia")` is identical to `plot_employed_total("Australia")`. 

```{r, "abs-plot-example", fig.height = 3, units = "cm", dpi = 96}
abs_plot(labour_force, indicator = "Employed total", states = "Australia")
```

```{r, "abs-plot-example-markdown", fig.height = 4, units = "cm", dpi = 96}
