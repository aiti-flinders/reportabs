...
abs_unemployment <- function(states,
                             years = 5,
                             compare_aus = TRUE,
                             ages = "Total (age)",
                             genders = "Persons",
  ...
  if (plot_index) {
    plot_title <- stringr::str_c("UNEMPLOYMENT: ",
  ...
  p <- ggplot2::ggplot(plot_data,
    ...
    ggplot2::labs(
      ...
      title = plot_title,
      subtitle = subtitle,
      caption = stringr::str_c("Source: 6202.0 - Labour Force, Australia, ",
...
abs_unemployment_rate <- function(states,
  ...
  if (plot_index) {
    plot_title <- stringr::str_c("UNEMPLOYMENT RATE: ",
                                 stringr::str_to_upper(stringr::str_c(strayr::strayr(states), collapse = " & ")))
